...
#                                                                                       #
# Ui.R                                                                                  #
# This file contains all necessary code to display the ui of the shinydashboard         #
...
body <- dashboardBody(
  ...
  #testpage is only used for testing items, and is normally not shown on the sidebar menu
  ...
  #allTeam is used to display the entire competition comparison
  ...
  #The dashboard page is used to display our teams data throughout the competition.
  tabItem(tabName = 'dashboard',
          fluidRow(
            box(
              ...
              #each output represents a visualization that is being displayed to the 
              #end user of the app.
